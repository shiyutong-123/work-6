...
trait SystemSettingsService {
  ...
  def saveSystemSettings(settings: SystemSettings): Unit = {
    ...
    props.setProperty(AuthenticatorLockEnabled, settings.basicBehavior.authenticatorLockEnabled.toString)
  ...
  def loadSystemSettings(props: java.util.Properties): SystemSettings = {
    SystemSettings(
      ...
      BasicBehavior(
        ...
        getValue(props, AuthenticatorLockEnabled, false)
      ),
      Ssh(
...
object SystemSettingsService {
  ...
  case class BasicBehavior(
    ...
    authenticatorLockEnabled: Boolean
  )
  ...
  private val AuthenticatorLockEnabled = "authenticator_lock_enabled"
